            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Formulaire d'ajoute des filieres</h6>
                        </div>
                        <br>
                    <form class="user" style="margin-left : 35% "; method="POST" action="process.php">
                        <?php  
                            
                            if(isset($_SESSION['message_filiere'])){ ?>
                            <div class="alert alert-danger" style = "margin-left : -50%">  
                                <?php  
                                    echo $_SESSION['message_filiere'];
                                    unset($_SESSION['message_filiere']);
                                ?> 
                            </div>
                        <?php } ?>
