      ...
      <?php  include("../side-bar.php"); ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                    <a href="ajouter-salle.php"  class="btn btn-primary" style="margin-left : 1%;">Ajouter une salle</a>
                    <br><br>
                    <?php  
                ...
                ?>
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tableau des salles</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody> 
                                        ...
                                        while($row = mysqli_fetch_array($res)){ ?>
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="modifier-salle.php?modifier=<?php echo $row['id_salle']; ?>"
                                                        class="btn btn-info"><i class="fa fa-edit"></i></a>
                                                    <a href="process.php?supprimer=<?php echo $row['id_salle']; ?>"
