            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Formulaire Modification des matières</h6>
                        </div>
                        <br>
                    <form class="user" style="margin-left : 35% "; method="POST" action="process2.php">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                ?>
                                <select name="id_fil" class="custom-select custom-select-sm form-control form-control-sm">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                ?>
                                <select name="id_prof" class="custom-select custom-select-sm form-control form-control-sm">
                                <?php  while($row = mysqli_fetch_array($res)){ ?>
