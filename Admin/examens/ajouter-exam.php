            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Formulaire d'ajoute des examens</h6>
                        </div>
                        <br>
                    <form class="user" style="margin-left : 35% "; method="POST" action="process-exam.php">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <button type="submit"  name="ajouter-e" class="btn btn-primary btn-user btn-block">
                                Ajouter 
                                </button>
                            </div>    
                        </div>
