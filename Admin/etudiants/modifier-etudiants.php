            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Formulaire Modification des étudiants</h6>
                        </div>
                        <br>
                    <form class="user" style="margin-left : 35% "; method="POST" action="process.php">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                value="<?php echo $filiere ?>"  id="filiere" placeholder="Filiere">
                            </div>    
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="password" class="form-control form-control-user" name="motdepass"
                                 id="motdepass" placeholder="Mot de pass">
                            </div>    
                        </div>
