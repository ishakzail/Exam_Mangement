                    ...
                    <form class="user" style="margin-left : 35% "; method="POST" action="process.php">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                value="<?php $prenom ?>"   id="prenom" placeholder="Prenom">
                            </div>    
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                ...
                                value="<?php $email ?>"  id="email" placeholder="Email">
                            </div>    
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" name="filiere"
                                value="<?php $filiere ?>" id="filiere" placeholder="Filiere">
                            </div>    
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <input type="password" class="form-control form-control-user" name="motdepass"
                                value="<?php $motdepass ?>" id="motdepass" placeholder="Mot de pass">
                            </div>    
                        </div>
