      ...
      <?php  include("../side-bar.php"); ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
                    <a href="ajouter-matiere"  class="btn btn-primary" style="margin-left : 1%;">Ajouter une Matière</a>
                    <br><br>
                                    ...
                                    <tbody> 
                                        ...
                                        while($row = mysqli_fetch_array($res)){ ?>
                                            <tr>
                                                ...
                                                <td> 
                                                    <a href="modifier-matieres.php?modifier=<?php echo $row['id_mat']; ?>"
                                                        class="btn btn-info"><i class="fa fa-edit"></i></a>
                                                    <a href="process2.php?supprimer=<?php echo $row['id_mat']; ?>"
